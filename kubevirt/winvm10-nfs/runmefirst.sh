...
virtctl image-upload --image-path ~/Downloads/Win10_22H2_English_x64v1.iso --size=10Gi pvc win10cd-pvc --access-mode ReadWriteMany --uploadproxy-url https://10.1.1.14:31001 --force-bind --insecure --namespace vms 
...
kubectl apply -f configmap.yaml -n vms
